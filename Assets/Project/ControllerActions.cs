...
//     version 1.3.0
//     from Assets/Project/ControllerActions.inputactions
//
...
public partial class @ControllerActions : IInputActionCollection2, IDisposable
{
    ...
    private IScreenActionMapActions m_ScreenActionMapActionsCallbackInterface;
    ...
    public struct ScreenActionMapActions
    {
        ...
        {
            if (m_Wrapper.m_ScreenActionMapActionsCallbackInterface != null)
            {
                @MouseClick.started -= m_Wrapper.m_ScreenActionMapActionsCallbackInterface.OnMouseClick;
                @MouseClick.performed -= m_Wrapper.m_ScreenActionMapActionsCallbackInterface.OnMouseClick;
                @MouseClick.canceled -= m_Wrapper.m_ScreenActionMapActionsCallbackInterface.OnMouseClick;
                @MouseMove.started -= m_Wrapper.m_ScreenActionMapActionsCallbackInterface.OnMouseMove;
                @MouseMove.performed -= m_Wrapper.m_ScreenActionMapActionsCallbackInterface.OnMouseMove;
                @MouseMove.canceled -= m_Wrapper.m_ScreenActionMapActionsCallbackInterface.OnMouseMove;
            }
            m_Wrapper.m_ScreenActionMapActionsCallbackInterface = instance;
            if (instance != null)
            {
