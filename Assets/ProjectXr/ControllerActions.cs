...
//     version 1.11.2
//     from Assets/ProjectXr/ControllerActions.inputactions
//
...
public partial class @ControllerActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""ScreenActionMap"",
            ""id"": ""e880f9c8-c733-45b5-aa0a-b94e169443cb"",
            ""actions"": [
                {
                    ""name"": ""MouseClick"",
                    ""type"": ""Button"",
                    ""id"": ""09a3c4ce-2161-4edc-b502-cec5b36d08ec"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""MouseMove"",
                    ""type"": ""Value"",
                    ""id"": ""21f5e289-a503-444a-889e-dd83b1b52c7a"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a9af4ee0-1129-4ff2-9c37-afe0f6a693d5"",
                ...
                {
                    ""name"": """",
                    ""id"": ""5ac65992-4c00-41f2-8748-0ab0df31d7bf"",
                ...
                {
                    ""name"": """",
                    ""id"": ""57b87d92-db4a-48c2-af14-7c199ea96703"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // ScreenActionMap
        m_ScreenActionMap = asset.FindActionMap("ScreenActionMap", throwIfNotFound: true);
        m_ScreenActionMap_MouseClick = m_ScreenActionMap.FindAction("MouseClick", throwIfNotFound: true);
        m_ScreenActionMap_MouseMove = m_ScreenActionMap.FindAction("MouseMove", throwIfNotFound: true);
    }

    ~@ControllerActions()
    {
        UnityEngine.Debug.Assert(!m_LeftHand.enabled, "This will cause a leak and performance issues, ControllerActions.LeftHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_RightHand.enabled, "This will cause a leak and performance issues, ControllerActions.RightHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_HMD.enabled, "This will cause a leak and performance issues, ControllerActions.HMD.Disable() has not been called.");
        ...
        UnityEngine.Debug.Assert(!m_EyeGaze.enabled, "This will cause a leak and performance issues, ControllerActions.EyeGaze.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_ScreenActionMap.enabled, "This will cause a leak and performance issues, ControllerActions.ScreenActionMap.Disable() has not been called.");
    }
    ...
    public struct LeftHandActions
    {
        ...
        public LeftHandActions(@ControllerActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @ControllerActions m_Wrapper;
        public RightHandActions(@ControllerActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @ControllerActions m_Wrapper;
        public HMDActions(@ControllerActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @ControllerActions m_Wrapper;
        public EyeGazeActions(@ControllerActions wrapper) { m_Wrapper = wrapper; }
    ...
    // ScreenActionMap
    private readonly InputActionMap m_ScreenActionMap;
    private List<IScreenActionMapActions> m_ScreenActionMapActionsCallbackInterfaces = new List<IScreenActionMapActions>();
    private readonly InputAction m_ScreenActionMap_MouseClick;
    private readonly InputAction m_ScreenActionMap_MouseMove;
    public struct ScreenActionMapActions
    {
        private @ControllerActions m_Wrapper;
        public ScreenActionMapActions(@ControllerActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @MouseClick => m_Wrapper.m_ScreenActionMap_MouseClick;
        public InputAction @MouseMove => m_Wrapper.m_ScreenActionMap_MouseMove;
        public InputActionMap Get() { return m_Wrapper.m_ScreenActionMap; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(ScreenActionMapActions set) { return set.Get(); }
        public void AddCallbacks(IScreenActionMapActions instance)
        {
            if (instance == null || m_Wrapper.m_ScreenActionMapActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ScreenActionMapActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IScreenActionMapActions instance)
        {
            @MouseClick.started -= instance.OnMouseClick;
            @MouseClick.performed -= instance.OnMouseClick;
            @MouseClick.canceled -= instance.OnMouseClick;
        ...
        public void RemoveCallbacks(IScreenActionMapActions instance)
        {
            if (m_Wrapper.m_ScreenActionMapActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IScreenActionMapActions instance)
        {
            foreach (var item in m_Wrapper.m_ScreenActionMapActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ScreenActionMapActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public ScreenActionMapActions @ScreenActionMap => new ScreenActionMapActions(this);
    ...
    public interface IScreenActionMapActions
    {
